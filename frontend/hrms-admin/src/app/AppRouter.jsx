...
import LeadGenerationReportPage from "@/features/crm/leads/LeadGenerationReportPage";
import LeadLogPage from "@/features/crm/leads/LeadLogPage";
...
import MembershipPlanListPage from "@/features/crm/membershipPlans/MembershipPlanListPage";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/crm/leads/report" element={<RoleGuard><LeadGenerationReportPage /></RoleGuard>} />
        <Route path="/crm/leads/log" element={<RoleGuard><LeadLogPage /></RoleGuard>} />
        ...
        <Route path="/crm/membership-plans" element={<RoleGuard><MembershipPlanListPage /></RoleGuard>} />
