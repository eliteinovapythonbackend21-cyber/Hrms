...
export default function BranchListPage() {
  ...
  const [blockedInfo, setBlockedInfo] =
    useState(null);

  const [statusFilter, setStatusFilter] =
    useState("active");

  const [viewingCompanyId, setViewingCompanyId] =
    useState(null);
                    ...
                    >
                      ...
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <div className="min-w-0">
                          ...
                          <p
                            title={companyName}
                            className="truncate text-[11px] font-semibold text-primary-600 dark:text-primary-400"
                          >
                            {companyName}
                          </p>
                      ...
                      <div className="ml-2 flex shrink-0 flex-col items-end">
                        ...
                        <span className="max-w-[80px] truncate font-mono text-[9px] text-slate-500 dark:text-slate-400">
                          {companyCode}
                        </span>
