  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex w-full flex-col gap-2.5 sm:flex-row lg:max-w-3xl">
            ...
            <select
              ...
              className="h-10 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm outline-none transition focus:border-primary-500 focus:ring-2 focus:ring-primary-500/10 sm:max-w-xs dark:border-slate-600 dark:bg-white/[0.06] dark:text-white"
            >
            ...
            <select
              ...
              className="h-10 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm outline-none transition focus:border-primary-500 focus:ring-2 focus:ring-primary-500/10 disabled:cursor-not-allowed disabled:opacity-50 sm:max-w-xs dark:border-slate-600 dark:bg-white/[0.06] dark:text-white"
            >
      ...
      {!isLoading && !isError && filteredDepartments.length === 0 && (
        <div className="flex min-h-[260px] flex-col items-center justify-center rounded-xl border border-slate-200 bg-white px-6 py-10 text-center dark:border-white/10 dark:bg-white/[0.04]">
      ...
      {/* PAGINATION */}
      <div className="rounded-xl border border-slate-200 bg-white px-2 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
