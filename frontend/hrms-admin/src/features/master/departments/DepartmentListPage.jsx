                      ...
                      {dept.description && (
                        <div className="mt-2 rounded-lg border border-slate-100 bg-white px-3 py-2 dark:border-slate-800 dark:bg-slate-900">
                          ...
                          <p
                            ...
                            className="mt-0.5 line-clamp-2 text-[11px] leading-4 text-slate-600 dark:text-slate-300"
                          >
                            {dept.description}
                          </p>
