                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 z-30 grid h-11 grid-cols-4 gap-px border-t border-slate-100 bg-slate-100 dark:border-white/10 dark:bg-white/[0.06]">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1 bg-white text-xs font-semibold text-primary-600 hover:bg-primary-50 disabled:opacity-40 dark:bg-white/[0.04] dark:text-primary-400"
                    >
                      <DownloadIcon />
                    </button>
