...
export default function OvertimeListPage() {
  ...
  const invalidateOvertimeQueries =
    () => {
  ...
  const handleDeactivate = async (
    ...
    try {
      ...
      showToast(
        err?.response?.data?.message ||
          "Failed to deactivate overtime record",
        "error"
      );
    } finally {
      setMutatingId(null);
  ...
  const handleReactivate = async (
    ...
    try {
      ...
      showToast(
        err?.response?.data?.message ||
          "Failed to reactivate overtime record",
        "error"
      );
    } finally {
      setMutatingId(null);
  ...
  return (
    <div className="min-h-full w-full space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <CountCard
          label="Inactive Overtime Records"
          value={inactiveCount}
...
function OvertimePeriodSelector({
  periodType,
  setPeriodType,
  selectedDate,
  setSelectedDate,
      ...
      {periodType ===
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-xs text-slate-400">
            Shows overtime records for the selected date.
          </p>
